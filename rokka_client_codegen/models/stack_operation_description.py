...
from rokka_client_codegen.models.stack_operation_description_properties import StackOperationDescriptionProperties  # noqa: F401,E501
...
class StackOperationDescription(object):
    ...
    """
    swagger_types = {
        'properties': 'dict(str, StackOperationDescriptionProperties)',
        'description': 'str',
        'required': 'list[str]',
        'one_of': 'list[str]'
    }
    ...
    def properties(self):
        ...
        :rtype: dict(str, StackOperationDescriptionProperties)
        """
    ...
    def properties(self, properties):
        ...
        :type: dict(str, StackOperationDescriptionProperties)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StackOperationDescription, dict):
